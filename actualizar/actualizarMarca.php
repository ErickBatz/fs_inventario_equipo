...
$id = $_GET['id'] ?? null;
$marca_actual = Marcas::obtenerMarcaPorID($conexion, $id);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body class="bg-gray-100">
    <main class="mx-auto max-w-3xl px-4 py-10">
        <header class="mb-8 flex items-center justify-between">
            <div>
                <h1 class="text-4xl font-bold text-gray-800">Actualizar Marca</h1>
                <p class="mt-2 text-lg text-gray-600">Completa los campos para actualizar.</p>
            </div>
            <a href="../marcas.php" class="rounded-lg bg-blue-500 px-4 py-2 font-bold text-white hover:bg-blue-700">
                Volver a marcas
            </a>
        </header>
        ...
        <section class="rounded-xl bg-white p-6 shadow-md sm:p-8">
            <form action="../objetos/agregarMarca.php" method="POST" class="space-y-6">
                ...
                <input type="hidden" name="marca_id" value="<?php echo htmlspecialchars($marca_actual['marca_id'] ?? ''); ?>">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <input type="text" id="txt_marca" name="txt_marca" required 
                               value="<?php echo htmlspecialchars($marca_actual['marca'] ?? ''); ?>" 
                ...
                <div class="flex justify-end gap-3 border-t border-gray-200 pt-6">
                    <a href="../marcas.php" class="rounded-lg bg-gray-200 px-4 py-2 font-bold text-gray-700 hover:bg-gray-300">Cancelar</a>
