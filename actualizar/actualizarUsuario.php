...
//llamamos todos los archivos que vamos a requerir como la conexion y los roles
    ...
    //obtenemos el id de usuarios
    $id = $_GET["id"];
    $usuario = Usuario::obtenerUsuariosPorID($conexion, $id);
...
<body class="bg-gray-100">
    <main class="mx-auto max-w-3xl px-4 py-10">
        <header class="mb-8 flex items-center justify-between">
            <div>
                <h1 class="text-4xl font-bold text-gray-800">Actualizar usuario</h1>
                <p class="mt-2 text-lg text-gray-600">Completa los campos para Actualizar usuario.</p>
            </div>
            ...
            <form action="../objetos/agregarUsuario.php" method="post" class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" id="txt_userName" name="txt_userName" value="<?php echo $usuario['usuario'];?>" required class="block w-full rounded-lg border border-gray-300 px-3 py-2.5 text-gray-900 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200">
                    </div>

                    <div>
                        <label for="txt_email" class="mb-2 block text-sm font-medium text-gray-700">Correo electrónico</label>
                        <input type="email" id="txt_email" name="txt_email" value="<?php echo($usuario['email']) ?>" required class="block w-full rounded-lg border border-gray-300 px-3 py-2.5 text-gray-900 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200">
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            ?>
                                ...
                                <?php if($rol['rol_id']==$usuario['rol_id']) echo ("selected"); ?>
                ...
                <div>
                    ...
                    <div class="relative">
                        <select name="estado" id="estado" required class="block w-full appearance-none rounded-lg border border-gray-300 bg-white px-3 py-2.5 pr-10 text-gray-900 outline-none transition duration-200 hover:border-blue-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-200">
